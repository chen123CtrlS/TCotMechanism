...
def main():
    ...
    parser.add_argument("--warmup_steps", default=2000, type=int, help="Warmup step. 0 for using warmup ratio.") #TODO:warm up
    ...
    parser.add_argument("--save_step_dense_interval", default=2000, type=int, help="")  #TODO:save steps
    ...
    model = Seq2SeqModel(
        ...
        init_weights=args.init_weights, #TODO:omit when load checkpoint
